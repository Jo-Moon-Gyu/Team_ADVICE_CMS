      ...
      <section class="container_2">
        <div class="contants_list">
            ...
            <div class="search_list">
              <button class="btnCancle"><a href="User">목록</a></button>
            </div>
        </div>
      </section>

	<form action ="accountChange" method ="post">
      <section class="management_list">
        <div class="managementList">
          <div class="management_email">
            <span>이메일</span>
            <p>${user.userEmail}</p>
          ...
          <div class="account_name">
            <div class="accountName">
                <span>이름</span>
                <input class="name_text" type="text" value = "${user.userName}" name ="userName">
            </div>
          </div>
          <div class="nickname">
            <div class="nickName">
          ...
          <div class="account_tel">
            <div class="accountTel">
                <span>연락처</span>
                <input class="tel" type="tel" value="${user.userPhone }" name="userPhone">
            </div>
          </div>
          <div class="sex">
            <div class="account_sex">
                <span>성별</span>
                <p>${user.userGender }</p>
            </div>
          </div>
          <div class="year">
            <div class="birth">
                <span>출생년도</span>
                <p>${user.userBirthyear }</p>
            </div>
          </div>
          <div class="approval">
            <div class="mg_approval">
                <span>승인</span>
                <input class="mgApproval" type="checkbox" value="true" name = "check">
                <p>계정승인</p>
            </div>
          </div>
          <div class="member">
            <div class="classification">
                <span>회원구분</span>
                <input class="memberCF" type="text" value ="${user.userRole}" name="userRole">
            </div>
          </div>
          <div class="revenue">
            <div class="Revenue">
          ...
          <div class="certificate">
            <div class="certificate_ac">
                <span>증명서</span>
                <div class="certification">
                    <img src="/images/${user.userAuth}" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)">
                </div>
            </div>
          </div>
        </div>
        <input class="update2" type="submit" value="수정">
    </section>
</form>
