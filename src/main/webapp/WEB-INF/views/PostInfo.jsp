    ...
    <div class="update_account">
      ...
      <section class="contents_list">
        <div class="contentsList">
          ...
          <div class="post_written">
            <span>작성글</span>
            <p>게시글 작성 내용 받아오기</p>
          </div>

          <div class="comment">
            <span>댓글 작성자 아이디</span>
            <textarea name="comment_admin" id="comment_admin" cols="100" rows="3"></textarea>
            <input class="btnSend" type="button" value="보내기">
          </div>
        </div>
        <a href="contants.html"><input type="button" class="contents_regist" value="나가기"></a>
      </section>
